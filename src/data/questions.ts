...
export const questionsData: QuestionsData = {
  ...
  q35: {
    ...
    respuestas: [
      ...
      "Throughput de datos móviles",
      "Latencia de red",
      "Tiempo de resolución de averías de red",
      "Disponibilidad de servicios de telecomunicaciones",
      "Capacidad de ancho de banda utilizada",
      "Número de interrupciones de servicio",
      "Tiempo medio de reparación (MTTR)",
      "Satisfacción del cliente en servicios móviles",
      "Cobertura geográfica de red",
    ],

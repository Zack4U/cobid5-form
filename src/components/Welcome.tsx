    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-b from-blue-50 to-teal-50">
            <div className="max-w-3xl w-full bg-white rounded-xl shadow-lg overflow-hidden transition-all transform hover:scale-[1.01]">
                <div className="bg-gradient-to-r from-blue-600 to-teal-500 px-8 py-6 text-white">
                    ...
                    <p className="opacity-90 text-lg">
                        Diagnóstico completo de gobernanza y gestión de TI para
                        su organización
                    </p>
                </div>
                ...
                <div className="p-8">
                    <p className="text-gray-700 mb-8 text-lg">
                        Esta herramienta le permitirá evaluar el nivel de
                        madurez en la gestión de TI de su empresa según el marco
                        de referencia COBIT 5, identificando áreas de mejora y
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">
                                    Preguntas que cubren todos los aspectos
                                    clave de COBIT 5
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">
                                    Interfaz intuitiva con navegación simple y
                                    visual
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">
                                    Gráficos y métricas para visualizar
                                    resultados
                                </p>
                            </div>
                        </div>
            ...
            <p className="mt-8 text-sm text-gray-500 text-center">
                Basado en COBIT 5 (Control Objectives for Information and
                Related Technologies)
                <br />© 2025 - Herramienta de Evaluación de Gobernanza TI
            </p>
        </div>
    );
};
